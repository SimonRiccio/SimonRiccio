...
| :--- | :--- | :--- |
| **Ethical Hacking / CTFs** | Reverse Engineering, Web Exploitation, Binary Exploitation, OSINT, Network Analysis. | ![Hacking](https://img.shields.io/badge/Hacking-Challenges-darkgreen?style=flat&logo=skull&logoColor=green) |
...
This is my dedicated lab for Cybersecurity projects, reflecting my journey from theory to professional practice. My most important repositories include:

* **CTF Write-ups:** Detailed solutions and methodologies for challenges from platforms like TryHackMe, Hack The Box, or others. **(My primary source of learning and skill growth).**
* **Security Tools:** Personal scripts (primarily in Python) for task automation, *reconnaissance*, or vulnerability analysis.
* **Proof-of-Concepts (PoC):** Implementations of exploits for well-known or recently discovered vulnerabilities.
